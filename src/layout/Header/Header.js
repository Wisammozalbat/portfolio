  ...
  return (
    <div className="header__container">
      <div className="header__content">
        ...
        <div
          className={['burger', burgerActive ? 'active' : ''].join(' ')}
          onClick={() => setBurgerActive((curr) => !curr)}
        >
        ...
        <ul className={['nav', burgerActive ? 'active' : ''].join(' ')}>
          ...
          <li
            className={[classes.technologies.join(' ')]}
            onClick={() => {
              toggleActive('technologies')
              setBurgerActive(false)
            }}
          >
          ...
          <li
            className={[classes.projects.join(' ')]}
            onClick={() => {
          ...
          <li
            className={[classes.contact.join(' ')]}
            onClick={() => {
        ...
        <div className="social-media">
          <a
            href="https://github.com/Wisammozalbat"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://www.linkedin.com/in/wisam-mozalbat/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://www.upwork.com/o/profiles/users/~01904da89701faa749/"
            target="_blank"
            rel="noreferrer"
          >
